...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public bool TransferMoney(Person receiver, double amountToTransfer)
        {
            ...
            amountToTransfer = Convert.ToDouble(Console.ReadLine());
            ...
            {
                Console.WriteLine($"Transfer failed: {name} doesn't have enough money.");
                return false;
            }
